<template>
  <section id="projects" class="section-container py-12 md:py-20">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="px-4 pb-4 flex flex-col flex-1">
            <h3
              class="text-xl font-bold text-cyber-primary mb-2 group-hover:text-cyber-secondary transition-colors"
            >
              {{ project.title }}
            </h3>
            ...
            <div class="flex-1 flex flex-col">
              ...
              <div class="flex flex-wrap gap-1 mt-auto pt-3">
                ...
                <span
                  ...
                  class="px-2 py-1 rounded text-xs text-cyber-textSecondary"
                >
    ...
    >
      <GlassCard @click.stop class="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl">
        <!-- Close Button -->
        <button
          @click="closeProjectDetail"
        ...
        >
          <svg
            class="w-6 h-6 text-cyber-primary"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div class="p-6">
          ...
          <div class="mb-6 pb-6 border-b border-cyber-primary/20">
            ...
            <div class="grid gap-3">
              <div
                v-for="req in selectedProject.requirements"
                :key="req"
                class="flex gap-2 text-cyber-textSecondary"
              >
